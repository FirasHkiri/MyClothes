                        ...
                        <div id="outer">
                            <div id="category" style="display: none" class="inner mid">
                                ...
                                @foreach($categories as $category)
                                    <form class="inner" action="{{ route('showByCategory',$category->id) }}" method="GET">
                                
                                            <button id="filterbtn" type="submit" class="btn btn-outline-info mR-20" data-toggle="tooltip" data-placement="bottom"
                                            title="Shoes"><img id="filtericon" src="{{ asset('assets/img/'.$category->image) }}" width="25px" height="25px"></button>
                    ...
                    <table id="dataTable" class="table table-bordered table-hover" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr height="100px">
                                ...
                                <td style="text-align:center" class="pt-5"><h6>{{ $product->partner->name }}</h6></td>
